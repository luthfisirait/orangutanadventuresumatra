...
export const nl = {
  metaTitle: "Orang-Oetan Trekking Sumatra | Bukit Lawang",
  metaDescription:
    "Boek ethische orang-oetan trekkings in Bukit Lawang met lokale gids, 4 uur tot 5 dagen, rivierkampen, rafting, vervoerhulp en WhatsApp.",
